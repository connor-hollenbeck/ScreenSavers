...
public abstract class Mover {
	...
	protected static Random ourGenerator = new Random();
	 ...
	 *            speed of the mover
	 * @param angle
	 *            direction of the mover (from 0 to 359)
	 * @param color
	 *            color of the shape
	 */
	 ...
	 * 
	 * @param pen
	 *            knows how to draw me on the screen
	 */
	...
	public void move(Dimension bounds) {
		int dx = Math
				.round((float) (speed * Math.cos(Math.toRadians(direction))));
		int dy = Math
				.round((float) (speed * Math.sin(Math.toRadians(direction))));
